...
// 设置页面标题和元数据
useHead({
  title: '华佗问诊 - AI超级智能体应用平台',
  meta: [
    {
      name: 'description',
      content: '华佗问诊是AI超级智能体应用平台的专业情感顾问，帮你解答各种恋爱问题，提供情感建议'
    },
    {
      name: 'keywords',
      content: '华佗问诊,医疗顾问,病情咨询,AI聊天,情感问题,AI智能体'
    }
  ]
})
...
const generateChatId = () => {
  return 'doctor_' + Math.random().toString(36).substring(2, 10)
}
